...
* conso_chauffage_ef Number
* conso_ecs_ef Number
* conso_refroidissement_ef Number
* conso_eclairage_ef Number
* conso_auxiliaires_ef Number
* conso_chauffage_ep Number
* conso_ecs_ep Number
* conso_refroidissement_ep Number
* conso_eclairage_ep Number
* conso_auxiliaires_ep Number
* cout_chauffage Number
* cout_ecs Number
* cout_refroidissement Number
* cout_eclairage Number
* cout_auxiliaires Number
